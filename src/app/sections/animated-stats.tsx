...
export default function AnimatedStats() {
  const stats = [
    { value: 99, suffix: '+', label: 'Websites Complete' },
{ value: 24, suffix: '/7', label: 'Customer Support Available' },
    { value: 10, suffix: 'x', label: 'Faster Website Creation Time' },
  ...
  return (
    <section className="bg-black py-16 md:py-4">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-3xl sm:text-4xl font-light mb-4 text-[#c8c2bd]">
            Empowering creators worldwide to produce stunning video animations at scale
          </span>
        </motion.h2>
        
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 font-light">
