...
export default function CTASection() {
  return (
    <section className="relative py-20 sm:py-24 lg:py-32 bg-black text-[calc(var(--_size)*0.022)] [--_factor:min(1000px,100vh)] [--_size:min(var(--_factor),100vw)]">
      <div className="w-full mx-auto px-4 sm:px-8 md:px-12 lg:px-32">
        <motion.div
          className="w-full relative py-6 sm:py-8 md:py-10 px-3 sm:px-6 md:px-8 rounded-2xl bg-black overflow-hidden flex justify-center items-center"
        ...
        >
          {/* Glow background */}
          <motion.div
            className="absolute h-full w-full max-w-[90vw] md:max-w-[44em]"
          ...
          {/* Text Content */}
          <div className="mx-auto text-center w-full flex flex-col items-center relative space-y-6 sm:space-y-8 max-w-2xl">
            <motion.h2
              className="text-[2em] xs:text-[2.4em] sm:text-[2.6em] md:text-[3em] font-semibold leading-[1.15] tracking-tight text-[#c8c2bd]"
            ...
            >
              ...
              >
                <span className="relative z-10 bg-clip-text text-transparent opacity-10 filter-[url(#glow-4)]">
            ...
            <motion.p
              className="relative mx-auto mt-6 sm:mt-8 md:mt-10 max-w-[95vw] sm:max-w-[32em] bg-gradient-to-b from-[#86868b] to-[#bdc2c9] bg-clip-text text-center font-semibold text-transparent text-sm sm:text-base md:text-lg"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              className="mx-auto w-full max-w-xs sm:max-w-xs md:max-w-sm flex flex-col justify-center items-center pt-8"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link
                href="/mockup-home"
                className="outline-none h-10 px-5 w-full rounded-xl bg-gradient-to-r from-[#86868b] to-[#bdc2c9] text-black font-semibold flex items-center justify-center hover:from-[#bdc2c9] hover:to-[#e7dfd6] transition-all duration-300 mt-2 sm:mt-5"
              >
                Get Started Now
              </Link>
              <p className="mt-3 sm:mt-4 text-xs sm:text-sm text-[#86868b] font-normal">No Credit Card Required</p>
            </motion.div>
          </div>
        </motion.div>
      </div>
